...
| D1 拆 `deepseek.ts`、D2 泛型评分编排 | import fan-out 大；D2 易过度抽象 | **D1 Done on `feat/web-llm-modularize`** — 见 [`docs/plans/2026-08-05-web-llm-modularize.md`](2026-08-05-web-llm-modularize.md)；D2 仍外置 |
