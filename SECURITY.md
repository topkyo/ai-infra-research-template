...
仓库仍为 **private** 时：**当前不接受匿名外部报告**。请勿通过 Issues 或 Pull Request 提交可利用细节。

仓库改为 public 且已在 GitHub 仓库 Settings 启用 **Private vulnerability reporting** 后，请仅通过该渠道提交漏洞。本文件不另设私人联系邮箱。
